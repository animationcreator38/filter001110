...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("🎃 𝗛𝗼𝘄 𝗧𝗼 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗠𝗼𝘃𝗶𝗲 🎃", url=await get_tutorial(query.message.chat.id))
        ])
...
async def filter_qualities_cb_handler(client: Client, query: CallbackQuery):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="‼️ Nᴏ Mᴏʀᴇ Pᴀɢᴇꜱ Aᴠᴀɪʟᴀʙʟᴇ ‼️",callback_data="pages")]
        )
    ...
    if query.data.startswith("file"):
        ...
        if settings is not None:
            buttons = [
                ...
                [
                    InlineKeyboardButton('ᴍᴅʙ Pᴏꜱᴛᴇʀ', callback_data=f'setgs#imdb#{settings["imdb"]}#{str(grp_id)}'),
       ...
       #@Deendayal_dhakad
        ...
        buttons = [[
            InlineKeyboardButton('🌟 Bᴜʏ Sᴜʙꜱᴄʀɪᴘᴛɪᴏɴ Nᴏᴡ 🌟', callback_data='purchase')
        ],[
            ...
            InlineKeyboardButton('⭅ Gᴏ Bᴀᴄᴋ ⭆', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
#Deendayal403
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭅ Bᴀᴄᴋ', callback_data='gold'),
            InlineKeyboardButton('5 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('Nᴇxᴛ ⭆', callback_data='diamond')
        ],[
            InlineKeyboardButton('⭅ Gᴏ Bᴀᴄᴋ ⭆', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭅ Bᴀᴄᴋ', callback_data='diamond'),
        ...
        if set_type == 'is_shortlink' and query.from_user.id not in ADMINS:
            return await query.answer(text=f"Hey {query.from_user.first_name}, ʏᴏᴜ ᴄᴀɴ'ᴛ ᴄʜᴀɴɢᴇ ꜱᴇᴛʟɪɴᴋ ꜱᴇᴛᴛɪɴɢꜱ ꜰᴏʀ ʏᴏᴜʀ ɢʀᴏᴜᴘ !\n\nɪᴛ'ꜱ ᴀɴ ᴀᴅᴍɪɴ ᴏɴʟʏ ꜱᴇᴛᴛɪɴɢ !", show_alert=True)
...
async def auto_filter(client, msg, spoll=False):
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                if settings["spell_check"]:
                    ai_sts = await m.edit('ɪ ᴛʜɪɴᴋ ʏᴏᴜ ᴍɪꜱꜱᴘᴇʟʟᴇᴅ ɪᴛ 😅,\nAɪ 🫡 ᴄʜᴇᴄᴋɪɴɢ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ ɴᴏᴡ')
                    is_misspelled = await ai_spell_check(chat_id = message.chat.id,wrong_name=search)
                    if is_misspelled:
                        await ai_sts.edit(f'<b>🤖 Aɪ ꜱᴜɢɢᴇsᴛᴇᴅ ᴍᴇ<code> {is_misspelled}</code> \nSᴏ Iᴍ Sᴇᴀʀᴄʜɪɴɢ ғᴏʀ <code>{is_misspelled}</code></b>')
    ...
    if imdb:
        ...
        if settings["button"]:
            cap = f"<b>🔍 𝐑𝐞𝐬𝐮𝐥𝐭 𝐅𝐨𝐫 : {search}\n\n💬 𝐒𝐞𝐚𝐫𝐜𝐡𝐞𝐝 𝐁𝐲 : {message.from_user.mention}\n\n⏳ 𝐒𝐞𝐚𝐫𝐜𝐡𝐞𝐝 𝐈𝐧 : {remaining_seconds} 𝐒𝐞𝐜\n\n⚡️ 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 : 𝐂𝐢𝐧𝐞𝐰𝐨𝐨𝐝 𝐏𝐯𝐭 𝐋𝐭𝐝.\n\n⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n</b>"
        else:
            cap = f"<b>🔍 𝐑𝐞𝐬𝐮𝐥𝐭 𝐅𝐨𝐫 : {search}\n\n💬 𝐒𝐞𝐚𝐫𝐜𝐡𝐞𝐝 𝐁𝐲 : {message.from_user.mention}\n\n⏳ 𝐒𝐞𝐚𝐫𝐜𝐡𝐞𝐝 𝐈𝐧 : {remaining_seconds} 𝐒𝐞𝐜\n\n⚡️ 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 : 𝐂𝐢𝐧𝐞𝐰𝐨𝐨𝐝 𝐏𝐯𝐭 𝐋𝐭𝐝.\n\n⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n</b>"
