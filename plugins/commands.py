...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('⚡️ Jᴏɪɴ Uᴘᴅᴀᴛᴇꜱ Cʜᴀɴɴᴇʟ ⚡️', url=CHNL_LNK)
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    InlineKeyboardButton('⟨ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Oᴡɴ Gʀᴏᴜᴘ ⟩', url=f'http://telegram.me/{temp.U_NAME}?startgroup=true')
                ],[
                    ...
                    InlineKeyboardButton('✨ Cɪɴᴇᴡᴏᴏᴅ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ ✨', callback_data="premium_info")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if message.command[1].startswith("reff_"):
        ...
        if user_id == message.from_user.id:
            await message.reply_text("ʜᴇʟʟᴏ ꜱɪʀ, Yᴏᴜ Cᴀɴ'ᴛ Rᴇғᴇʀ Yᴏᴜʀsᴇʟғ 🙅🏻\n\nꜱʜᴀʀᴇ ᴛʜɪꜱ ʀᴇꜰᴇʀᴀʟʟ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ꜰʀɪᴇɴᴅꜱ, ꜰᴀᴍɪʟʏ, ɢʀᴏᴜᴘꜱ ᴀɴᴅ ɢᴇᴛ 10 ᴄɪɴᴇᴡᴏᴏᴅ ᴄᴏɪɴꜱ ᴡʜᴇɴ ʏᴏᴜʀ ᴄɪɴᴇᴡᴏᴏᴅ ᴄᴏɪɴꜱ ʀᴇᴀᴄʜ 𝟣𝟢𝟢 ᴛʜᴇɴ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ 𝟣𝟢 ᴅᴀʏꜱ ꜰʀᴇᴇ ᴄɪɴᴇᴡᴏᴏᴅ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ.")
            return
        if referdb.is_user_in_list(message.from_user.id):
            await message.reply_text("ʏᴏᴜ ʜᴀᴠᴇ ᴀʟʀᴇᴀᴅʏ ᴜꜱᴇᴅ ꜱᴏᴍᴇᴏɴᴇ'ꜱ ʀᴇꜰᴇʀʀᴀʟ ʟɪɴᴋ 🫣")
            return
        try:
        ...
        if fromuse == 100:
            ...
            await message.reply_text(user_id, f"ʏᴏᴜ ʜᴀᴠᴇ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ 🎊 ᴜꜱᴇᴅ {message.from_user.mention}'ꜱ  ʀᴇꜰᴇʀʀᴀʟ ʟɪɴᴋ") 	
            seconds = 86400
            if seconds > 0:
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(
                f"<b><u>⚠️⚠️ 𝐈𝐌𝐏𝐎𝐑𝐓𝐀𝐍𝐓 𝐖𝐀𝐑𝐍𝐈𝐍𝐆 ⚠️⚠️</u></b>\n\n"
                f"ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ, ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u><code>{get_time(DELETE_TIME)}</code></u> ⏳ <i></b>"
                "ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴛᴏ ᴀ ꜰʀɪᴇɴᴅ ⏩ ᴏʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ꜰᴏʟᴅᴇʀ.</i>.\n\n"
                "<b><i>ᴛʜᴇɴ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ⚡ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ᴛʜᴇʀᴇ. ᴛʜᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴇʀᴇ</i></b>",
                quote=True
            )
            await asyncio.sleep(DELETE_TIME)
            await msg.delete()
            await k.edit_text("<b>ʏᴏᴜʀ ꜰɪʟᴇ/ᴠɪᴅᴇᴏ ɪꜱ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ!!!\n\nᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ꜰɪʟᴇ ᴀɢᴀɪɴ</b>",reply_markup=InlineKeyboardMarkup(btn))
            return
        except:
            pass
...
async def settings(client, message):
    ...
    if settings is not None:
        buttons = [        
            ...
            [
                InlineKeyboardButton('⭅ Cʟᴏꜱᴇ Sᴇᴛᴛɪɴɢꜱ Mᴇɴᴜ ​⭆', 
        ...
        btn = [[
                InlineKeyboardButton("🔒 Oᴘᴇɴ Pʀɪᴠᴀᴛᴇʟʏ 🔒", callback_data=f"opnsetpm#{grp_id}")
              ],[
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ !\nᴘʟᴇᴀꜱᴇ ꜰᴏʟʟᴏᴡ ᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ ɢɪᴠᴇ ᴍᴇ ᴄᴏᴍᴍᴀɴᴅ ᴀʟᴏɴɢ ᴡɪᴛʜ ᴡᴇʙꜱɪᴛᴇ ᴅᴏᴍᴀɪɴ ᴀɴᴅ ᴀᴘɪ.\n\nꜰᴏʀᴍᴀᴛ : <code>/setlink example.com c8dacdff6e91a8e4b4f093fdb4d8ae31bc273c1a</code>")
